...
function LabelModal({ product, onClose }) {
  ...
  <text x="${w/2}" y="${Math.round(h*0.16)}" text-anchor="middle" font-family="Georgia,serif" font-size="${Math.round(h*0.1)}" letter-spacing="6" fill="#111" font-weight="bold">SOLSUR</text>
